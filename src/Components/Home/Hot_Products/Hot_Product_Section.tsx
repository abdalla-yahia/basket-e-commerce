...
export default function Hot_Products_Section() {
    ...
    return (
        <section className="w-[100%]">
            {/*Section Title*/}
            <Section_Title title={'HOT PRODUCT FOR THIS WEEK'} description={"Don't miss this opportunity at a special discount just for this week."} href={'/products/shop'} />
            {/*Products*/}
            <div className="w-full bg-white flex flex-col md:flex-row justify-center md:justify-between rounded-2xl items-center md:items-start p-2 md:p-5 mt-3 border border-[#ED174A] overflow-hidden">
                {/*Image Section*/}
                <div className="relative w-full md:w-[20%] flex justify-center items-center">
                    {/*Image*/}
                ...
                <div className="flex flex-col w-full md:w-[80%] gap-3 justify-start items-start ">
                    ...
                    <div className="flex flex-wrap justify-between items-center">
                        ...
                        <p className="text-start mx-2 w-full md:w-[100px] font-[400] text-[#3E445A] text-[10px] md:text-[14px]">Remains until the end of the offer</p>
                    </div>
                </div>
            </div>
        </section>
