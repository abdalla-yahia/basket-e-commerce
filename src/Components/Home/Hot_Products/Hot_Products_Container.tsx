...
export default function Hot_Products_Container() {
  return (
    <section className="w-[90%] flex justify-between items-start mt-5 gap-5">
        ...
        <section className="w-full md:w-[75%] flex flex-col justify-between items-start gap-5">
            {/*Head Image*/}
            <div className="w-full bg-top-right bg-no-repeat h-[125px] overflow-hidden rounded-2xl bg-[#F8EFEA] flex justify-between items-center">
                ...
                <div className="w-[60%] pl-8 py-3">
                    <p className="font-[400] text-[10px] md:text-[14px] text-[#9B9BB4]" style={{lineHeight:'16.8px',letterSpacing:'0%'}}>Always Taking Care</p>    
                    <h1 className="font-[600] text-[12px] md:text-[18px] text-[#71778E]" style={{lineHeight:'21.6px',letterSpacing:'-0.8%'}}>In store or online your health & safety is our top priority.</h1>
                </div>
                {/*Image*/}
