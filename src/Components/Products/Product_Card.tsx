...
export default function Product_Card({ img, offer, title, rating, oldprice, price, iscounter }: { img: string, offer: string, title: string, rating: string, oldprice: string, price: string, iscounter?: boolean }) {
    ...
    return (
        <div className="flex shadow shadow-[#EDEEF5] hover:scale-105 duration-500 hover:z-50 flex-col border border-[#EDEEF5] relative gap-3 bg-white px-6 py-5 justify-center items-start w-1/4">
            {/*Span Offers*/}
