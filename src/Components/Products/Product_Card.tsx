...
export default function Product_Card({img,offer,title,rating,oldprice,price}:{img:string,offer:string,title:string,rating:string,oldprice:string,price:string}) {
    const [counter,setCounter]= useState(0)
  return (
    <div className="flex flex-col border border-[#EDEEF5] relative gap-3 bg-white px-6 py-5 justify-center items-start w-1/4">
        {/*Span Offers*/}
...
<rect width="9.9" height="10" fill="white" transform="matrix(1 0 0 -1 55.63 11.38)"/>
        ...
        {/*Count*/}
        <div className="flex justify-between items-center w-full border overflow-hidden border-[#EDEEF5] rounded-[50px] ">
