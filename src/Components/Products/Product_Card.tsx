...
export default function Product_Card({ slug,img, offer, title, rating, oldprice, price,quantity, iscounter }: {slug:string, img: string, offer: string, title: string, rating: string, oldprice: string, price: string,quantity?:number, iscounter?: boolean }) {
    ...
    return (
        <div className="Product-Card flex min-h-[180px] md:min-h-[340px] shadow shadow-[rgb(237,238,245)] hover:-translate-y-5 duration-300 hover:z-40 flex-col border border-[#EDEEF5] relative gap-3 bg-white px-3 py-4 justify-between items-stretch w-full md:w-1/4 flex-shrink-0">
