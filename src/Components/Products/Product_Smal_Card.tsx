...
export default function Product_Smal_Card({ slug, img, offer, title, oldprice, price }: {slug:string, img: string, offer: string, title: string, oldprice: string, price: string }) {
  return (
    <div className="flex flex-shrink-0 shadow w-[130px] min-h-[175px] shadow-[rgb(237,238,245)] flex-col border border-[#EDEEF5] relative gap-2 bg-white px-2 py-3 justify-center items-center">
