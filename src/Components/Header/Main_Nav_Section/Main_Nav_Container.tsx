...
export default function Main_Nav_Container({AllCategories}:{AllCategories:{categories:UpdateCategory[]}}) {
  return (
    <div className='h-[92.5px] w-full flex justify-center items-center border-b-[0.5px] border-[#E3E4E6]'>
        <div className="w-[90%]  h-[92.5px] flex justify-between items-center ">
            {/*Select Category*/}
            <Categories_Dropdown AllCategories={AllCategories}/>
            {/*Main Nav*/}
            <Main_NavBar AllCategories={AllCategories}/>
        </div>
    </div>
  )
}
