    ...
    return (
        <div className="flex justify-center items-center gap-2">
            ...
            <div className="cart-icon  relative ">
                ...
                {/*Items Count */}
                <span className="z-30 absolute -right-1 -top-2 text-white bg-red-700 p-1 rounded-full">0</span>
            </div>
        </div>
    )
}
