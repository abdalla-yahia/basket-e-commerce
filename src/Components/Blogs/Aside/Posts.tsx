    ...
    <div className="flex flex-col">
                ...
                <div className="flex flex-col gap-3 justify-start items-start border border-[#EDEEF5] p-2">
                    ...
                    <div className="flex justify-center items-center w-fit h-fit gap-4">
                        ...
                        <span className="text-[#202435] line-clamp-2 text-[8px] md:text-[14px] font-[500]">But I must explain to you how all this mistaken idea</span>
                    </div>
                    <div className="flex justify-center items-center w-fit h-fit gap-4">
                        {/*Image*/}
                        <div className="relative rounded-full flex justify-center items-center w-[60px] h-[60px]">
                        ...
                        <span className="text-[#202435] line-clamp-2 text-[8px] md:text-[14px] font-[500]">The Problem With Typefaces on the Web</span>
                    </div>
                    <div className="flex justify-center items-center w-fit h-fit gap-4">
                        {/*Image*/}
                        <div className="relative rounded-full flex justify-center items-center w-[60px] h-[60px]">
                        ...
                        <span className="text-[#202435] line-clamp-2 text-[8px] md:text-[14px] font-[500]">English Breakfast Tea With Tasty Donut Desserts</span>
                    </div>
                </div>
            </div>
  )
