...
export async function GEt(request:NextRequest,{params}:{params:Promise<{id:string}>}):Promise<NextResponse>{
    try {
        ...
        return NextResponse.json({message:'Get Order Successfully',order},{status:200})
    } catch (error) {
        return NextResponse.json({message:'Faild To Get Order',error},{status:500})
    }
}
...
export async function POST(request:NextRequest,{params}:{params:Promise<{id:string}>}):Promise<NextResponse>{
    try {
        ...
        return NextResponse.json({message:'Order Updated Successfully',order},{status:201})
    } catch (error) {
        return NextResponse.json({message:'Faild To Update Order',error},{status:500})
    }
}
...
export async function DELETE(request:NextRequest,{params}:{params:Promise<{id:string}>}){
    try {
        ...
        return NextResponse.json({message:'Faild To Delete Order',error},{status:500})
    }
}